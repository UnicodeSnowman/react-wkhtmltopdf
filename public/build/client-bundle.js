...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_React$Component) {
	    ...
	    _createClass(App, [{
	        ...
	        value: function addField(field) {
	            this.setState(_defineProperty({}, field, this.state[field].concat('')));
	        }
	    }, {
	        key: 'updateField',
	        value: function updateField(text, fieldName, index) {
	            var value = void 0;
	            if (typeof index === 'number') {
	                var list = this.state[fieldName];
	                value = [].concat(_toConsumableArray(list.slice(0, index)), [text], _toConsumableArray(list.slice(index + 1)));
	            } else {
	                value = text;
	            }
	...
	_reactDom2.default.render(_react2.default.createElement(App, null), document.getElementById('form'));
	...
	var Form = function (_React$Component) {
	    ...
	    _createClass(Form, [{
	        ...
	        value: function render() {
	            ...
	            var onAddFriend = _props.onAddFriend;
	            var onUpdateField = _props.onUpdateField;
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            "First Name:",
	                            React.createElement("br", null),
	                            React.createElement("input", { type: "text", placeholder: "First Name...", value: data.firstName, onChange: function onChange(e) {
	                                    return onUpdateField(e.target.value, 'firstName');
	                                } })
	                        ),
	                        React.createElement(
	                            "label",
	                            ...
	                            "Last Name:",
	                            React.createElement("br", null),
	                            React.createElement("input", { type: "text", placeholder: "Last Name...", value: data.lastName, onChange: function onChange(e) {
	                                    return onUpdateField(e.target.value, 'lastName');
	                                } })
	                        )
	                    ),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            "Address:",
	                            React.createElement("br", null),
	                            React.createElement("input", { type: "text", placeholder: "Address...", value: data.address, onChange: function onChange(e) {
	                                    return onUpdateField(e.target.value, 'address');
	                                } })
	                        )
	                    ),
	                    React.createElement("br", null),
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            "Occupation:",
	                            React.createElement("br", null),
	                            React.createElement("input", { type: "text", placeholder: "Occupation...", value: data.occupation, onChange: function onChange(e) {
	                                    return onUpdateField(e.target.value, 'occupation');
	                                } })
	                        ),
	                        React.createElement(
	                            "label",
	                            ...
	                            "Company:",
	                            React.createElement("br", null),
	                            React.createElement("input", { type: "text", placeholder: "Company...", value: data.company, onChange: function onChange(e) {
	                                    return onUpdateField(e.target.value, 'company');
	                                } })
	                        )
	                    ),
	                    React.createElement("br", null),
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                ...
	                                { onClick: function onClick() {
	                                        return onAddField('interests');
	                                    } },
	                                "Add New +"
	                            )
	                        ),
	                        data.interests.map(function (interest, index) {
	                            return React.createElement(
	                                "div",
	                                { key: index },
	                                React.createElement("input", {
	                                    ...
	                                    onChange: function onChange(e) {
	                                        return onUpdateField(e.target.value, 'interests', index);
	                                    } })
	                            );
	                        })
	                    ),
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                "a",
	                                { onClick: function onClick() {
	                                        return onAddField('friends');
	                                    } },
	                                "Add New +"
	                            )
	                        ),
	                        data.friends.map(function (friend, index) {
	                            return React.createElement(
	                                "div",
	                                { key: index },
	                                React.createElement("input", {
	                                    ...
	                                    value: friend,
	                                    onChange: function onChange(e) {
	                                        return onUpdateField(e.target.value, 'friends', index);
	                                    } })
	                            );
	                        })
	                    ),
